...
class MovieController {
  ...
  Future<void> deleteMovie({bool deleteFiles = false, bool addExclusion = false}) async {
    final repository = ref.read(movieRepositoryProvider);
    if (repository == null) return;
    await repository.deleteMovie(movieId, deleteFiles: deleteFiles, addExclusion: addExclusion);
  }
...
final movieControllerProvider = Provider.autoDispose.family<MovieController, int>((ref, movieId) {
