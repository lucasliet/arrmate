...
class _AssistantScreenState extends ConsumerState<AssistantScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<AssistantState>(assistantProvider, (prev, next) {
      if (prev?.isDownloading != next.isDownloading && next.isDownloading) {
  ...
  void _confirmDelete(
    BuildContext context,
    AssistantNotifier notifier,
    AssistantInstalledModel model,
  ) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Delete Model'),
        content: Text('Remove "${model.label}" from your device?'),
        actions: [
          TextButton(
...
class _DownloadProgressDialogState
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<AssistantState>(assistantProvider, (prev, next) {
      if (prev?.isDownloading == true && !next.isDownloading) {
        if (mounted) {
